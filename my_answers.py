...
class NeuralNetwork(object):
    ...
    def run(self, features):
        ...
        #print("self.final_outputs=", self.weights_input_to_hidden.shape)
...
#  https://github.com/mvirgo/DLND-Projects/tree/master/first-neural-network
#  Udacity excerices/quizes
